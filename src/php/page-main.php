...
<?php 
    ...
    $streamers_array = get_lim_streamers();
...
<main class="main mainPage">
    ...
    <div class="mainPage__filterButtons">
        <a href="<?php echo site_url() ?>" class="mainPage__filterButton">
            ...
            <div class="mainPage__filterButtonContainer">
                ...
                <div class="mainPage__filterButtonContainerValue"><?php echo count($streamers_array_total) ?></div>
            </div>
        ...
        <a href="<?php echo site_url() ?>/categories?showCountries=true&showPlatforms=false" class="mainPage__filterButton">
        ...
        <a href="<?php echo site_url() ?>/categories?showCountries=false&showPlatforms=true" class="mainPage__filterButton">
        ...
        <a href="<?php echo site_url() ?>/search?showLiked=true&searchName=false&platform=all&country=all&isGamble=all&isWorked=all&isBlocked=all" class="mainPage__filterButton">
    ...
    <div class="mainPage__tableNavigation">
        <div class="mainPage__tableNavigationButtons">
            <a class="mainPage__tableNavigationButton disabled">
                <svg width="14" height="15" viewBox="0 0 14 15" fill="none" xmlns="http://www.w3.org/2000/svg"
            ...
            <a href="<?php echo  site_url() . '/pagination?list=2' ?>" class="mainPage__tableNavigationButton">
                <svg width="14" height="15" viewBox="0 0 14 15" fill="none" xmlns="http://www.w3.org/2000/svg"
    ...
    <div class="mainPage__filterContainer filterContainer jsHidden">
        ...
        <div class="filterContainer__filters">
            ...
            <div class="filterContainer__row">
                ...
                <label for="set_isGamble" class="filterContainer__selectLabel">
